...
- `pandas.concat([data1, data2, ...], axis=0)` 默认 axis=0 即竖直拼接，指定为 1 可按行拼接
    ...
    **正常拼接：**
    ...
    <img src="doc/pic/README/image-20220215185340085.png" alt="image-20220215185340085" style="zoom:50%;" />

    

    **索引（index）不一致的情况下进行按列拼接拼接：**

    <img src="doc/pic/README/image-20220215185418869.png" alt="image-20220215185418869" style="zoom:50%;" />
